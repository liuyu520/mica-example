...
import net.dreamlu.convention.model.JobCandidateItem;
import net.dreamlu.convention.service.IJobCandidateItemService;
 ...
 */
@Controller
@RequestMapping("/jobCandidateItem")
public class JobCandidateItemController extends BaseController {
	...
	public EasyPage<JobCandidateItem> dataGrid(JobCandidateItem jobCandidateItem, PageVO pageVO) {
		...
		Page<JobCandidateItem> pages = pageVO.toPage();
		jobCandidateItemService.page(pages, ew);
	...
	public String addPage() {
		return "system/jobCandidateItem/jobCandidateItemAdd";
	}
	...
	public String editPage(Model model, Integer id) {
		JobCandidateItem jobCandidateItem = jobCandidateItemService.getById(id);
		model.addAttribute("jobCandidateItem", jobCandidateItem);
		return "system/jobCandidateItem/jobCandidateItemEdit";
	}
